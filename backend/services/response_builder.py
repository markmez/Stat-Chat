...
def build_matchup(batter_name: str, pitcher_name: str,
    ...
    try:
        ...
        if h2h and h2h[0]:
            pa = h2h[0]
            parts.append(f"**Career Head-to-Head ({pa} PA)**")
            parts.append("[STATGRID]")
            ...
            # Scope is CAREER as of 2026-09-01: head_to_head holds every
            # regular-season meeting back to 1920 (Retrosheet backfill).
            parts.append(f"They've never faced each other.\n")
