...
enum SampleQuery {
    static let all: [String] = [
        ...
        "What was Judge's slash line last season?",
        "Kyle Tucker's splits vs left-handed pitching",
        "Who had the most walks last season?",
        "Trea Turner vs Gunnar Henderson last season",
        "Who drove in the most runs last season?",
        "What is OPS+?",
        "How did Corey Seager hit last season?",
        "Did Rafael Devers go on any hot runs last season?",
        "Lowest strikeout rate among qualifiers last season",
        "Freddie Freeman or Vladimir Guerrero Jr last season?",
        "What were Mookie Betts' stats last season?",
        "Who hit lefties the hardest last season?",
    ]
}
